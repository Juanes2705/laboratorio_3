...
public class controladorMenu implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource().equals(MP.Jlistados)) {
            listadoJframe Lf = new listadoJframe(MP);
            Lf.setVisible(true); // Muestra la ventana de listados
            MP.setVisible(false); // Oculta la ventana principal si es necesario
        }
